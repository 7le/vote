...
public class VoteController extends BaseController {
    ...
    public ResultBean publish(HttpServletRequest request,
    ...
    public ResultBean show(HttpServletRequest request,@ApiParam(required = true, name = "event_id", value = "投票事件id") @PathVariable Integer event_id) {
    ...
    public ResultBean join(HttpServletRequest request,
    ...
    public ResultBean interestedList(HttpServletRequest request) {
        Integer user_id=null;
        try {
            user_id=Integer.valueOf(EncryptUtil.aesDecrypt((String)request.getAttribute("token"), EncryptUtil.KEY));
        } catch (Exception e) {
    ...
    public ResultBean interested(HttpServletRequest request,
    ...
    public ResultBean listJoin( HttpServletRequest request) {
        Integer user_id=null;
        try {
            user_id=Integer.valueOf(EncryptUtil.aesDecrypt((String)request.getAttribute("token"), EncryptUtil.KEY));
        } catch (Exception e) {
    ...
    public ResultBean listPublish(HttpServletRequest request) {
        Integer user_id=null;
        try {
            user_id=Integer.valueOf(EncryptUtil.aesDecrypt((String)request.getAttribute("token"), EncryptUtil.KEY));
        } catch (Exception e) {
